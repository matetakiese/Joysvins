...
const Auth = () => {
  ...
  const handleGoogleAuth = () => {
    // Code pour gérer l'authentification avec Google
    // Rediriger l'utilisateur vers la page d'authentification Google
    window.location.href = 'URL_de_l_authentification_Google';
  };
  ...
  return (
    <div className=" flex items-center justify-center bg-gray-50  sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div>
          <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">{isLogin ? 'Connexion' : 'Inscription'}</h2>
        </div>
